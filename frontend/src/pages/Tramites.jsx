...
const CATALOG = {
  ...
  vehiculo: {
    title: 'Vehículo',
    items: [
      { title: 'Transferencia de Vehículo', desc: 'Cambio de titularidad ante la DGT. Coches y motos, compradores y vendedores particulares.', price: '190 €', href: 'preview-transferencia.html' },
      { title: 'Baja de Vehículo', desc: 'Deja de pagar impuestos por un vehículo que ya no usas. Tramitamos la baja definitiva o temporal.', price: '190 €', href: 'preview-baja-vehiculo.html' },
      { title: 'Cancelación de Reserva de Dominio', desc: 'Elimina la reserva de dominio de tu vehículo una vez finalizado el préstamo con el banco o financiera.', price: '120 €', href: 'preview-cancelacion-dominio.html' },
      { title: 'Duplicado Permiso de Circulación', desc: 'Pérdida o deterioro del permiso de circulación. Autorización provisional inmediata mientras se tramita el definitivo.', price: '70 €', href: 'preview-duplicado-circulacion.html' },
    ],
  },
};
