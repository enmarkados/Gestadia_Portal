...
describe('Transferencia', () => {
  ...
  it('submits the form to /api/leads with the Transferencia de Vehículo tramite', async () => {
    ...
    await waitFor(() =>
      expect(global.fetch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          method: 'POST',
          body: JSON.stringify({ nombre: 'Ana Ruiz', telefono: '600111222', email: 'ana@example.com', tramite: 'Transferencia de Vehículo' }),
        })
      )
    );
  });
