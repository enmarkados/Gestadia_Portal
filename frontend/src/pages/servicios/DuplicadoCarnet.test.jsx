...
describe('DuplicadoCarnet', () => {
  ...
  it('submits the form to /api/leads with the Duplicado de Carnet de Conducir tramite', async () => {
    ...
    await waitFor(() =>
      expect(global.fetch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          method: 'POST',
          body: JSON.stringify({ nombre: 'Ana Ruiz', telefono: '600111222', email: 'ana@example.com', tramite: 'Duplicado de Carnet de Conducir' }),
        })
      )
    );
  });
